...
**Blog post:** [Building the Primitive Mina's Funded Reclaim Integration Was Missing](https://kvkthecreator.github.io/zk-proof-of-origin/blog/zk-ecdsa-primitive/) — full technical write-up of the audit → primitive → upstream-PR journey.
